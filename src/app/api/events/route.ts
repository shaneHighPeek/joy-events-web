      ...
      const mappedEvents = harvestedEvents
        .filter((e: any) => {
          ...
          if (locationParam === 'BRISBANE') {
            locationMatch = venue.includes('BRISBANE') || source.includes('BCC') || venue.includes('MOUNT GRAVATT');
          } else if (locationParam === 'GC') {
            locationMatch = venue.includes('GOLD COAST') || venue.includes('HOTA') || venue.includes('SURFERS PARADISE') || source.includes('GCCC') || venue.includes('COOLANGATTA') || venue.includes('CARRARA') || venue.includes('BROADBEACH') || venue.includes('TUGUN') || venue.includes('HOPE ISLAND');
          } else if (locationParam === 'SC') {
            locationMatch = venue.includes('SUNSHINE') || venue.includes('MAROOCHYDORE') || venue.includes('NOOSA') || venue.includes('MOOLOOLABA');
          } else {
            locationMatch = true;
          }
